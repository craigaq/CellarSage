...
MERCHANT_REGISTRY: dict = {
    ...
    "liquorland": {
        ...
        "pages": 6,        # try up to 6 pages; stops early if a page is short
        "enabled": True,
        "actor_input": {
            "operation": "category",
            "path": "/wine",
    ...
    "liquorland_search_gewurztraminer": {
        "actor_id": "dromb/liquorland-au-catalog-product-lookup-unofficial",
        "max_items": 50,
        "pages": 2,
        "enabled": True,
    ...
    "liquorland_search_merlot_premium": {
        "actor_id": "dromb/liquorland-au-catalog-product-lookup-unofficial",
        "max_items": 50,
        "pages": 3,
        "enabled": True,
    ...
    "liquorland_search_pinot_grigio": {
        "actor_id": "dromb/liquorland-au-catalog-product-lookup-unofficial",
        "max_items": 50,
        "pages": 3,
        "enabled": True,
    ...
    "liquorland_search_sauvignon_blanc": {
        "actor_id": "dromb/liquorland-au-catalog-product-lookup-unofficial",
        "max_items": 50,
        "pages": 3,
        "enabled": True,
